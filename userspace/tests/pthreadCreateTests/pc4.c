...
int function2pc4(void* simple_argument)
{
    while(1)
    {
    }
...
int pc4()
{
    ...
    rv = pthread_create(&thread_id1, NULL, (void * (*)(void *))function2pc4, NULL);
    assert(rv == 0 && "Return value on succesful creation should be 0.");
    rv = pthread_create(&thread_id2, NULL, (void * (*)(void *))function2pc4, NULL);
    assert(rv == 0 && "Return value on succesful creation should be 0.");

...
class ArchMemory
{
  public:
     ...
     */
    [[nodiscard]] bool mapPage(uint64 virtual_page, uint64 physical_page, uint64 user_access, ustl::vector<size_t>& preallocated_pages);
    ...
    ArchMemory(ArchMemory const &src, ustl::vector<size_t>& preallocated_pages);
    ...
    void copyPage(size_t virtual_addr, ustl::vector<size_t>& preallocated_pages);
